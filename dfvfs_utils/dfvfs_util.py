...
class DfvfsUtil(object):
    ...
    def get_pathspec_basic_information(self, pathspec):
        ...
        pathspec_information['directory'] = os.path.dirname(pathspec_information['path'])
        pathspec_information['extension'] = os.path.splitext(pathspec_information['file_name'])[1][1:].lower() or ""
...
def Main():
    # TODO move all this into test pages
    logging.basicConfig(
        level=logging.INFO, format=u'[%(levelname)s] %(message)s')

    xp = '/media/sf_J_DRIVE/xp-tdungan-c-drive.E01'
    win7 = '/media/sf_J_DRIVE/win7-64-nfury-c-drive.E01'

    print('Base path xp: ')
    dfvfs_util_xp = DfvfsUtil(xp)
    print(str(dfvfs_util_xp.encode_pathspec(dfvfs_util_xp.base_path_specs)))
    print('')

    print('')
    print('[fls] List root dir xp: ')
    print(str(dfvfs_util_xp.list_directory(dfvfs_util_xp.base_path_specs, False, True)))

    print('')
    print('[fls] List WINDOWS dir xp: ')
    windows_dir_pathspec = '{"inode": 28, "type_indicator": "TSK", "__type__": "PathSpec", "location": "/WINDOWS", "parent": {"type_indicator": "EWF", "__type__": "PathSpec", "parent": {"type_indicator": "OS", "__type__": "PathSpec", "location": "/media/sf_J_DRIVE/xp-tdungan-c-drive.E01"}}}'
    dfvfs_util_xp.list_directory(dfvfs_util_xp.decode_pathspec(windows_dir_pathspec), False, True)

    print('')
    print('[icat] Print comsetup.log to stdout from xp')
    dfvfs_util_xp.export_file(dfvfs_util_xp.decode_pathspec('{"inode": 3796, "type_indicator": "TSK", "__type__": "PathSpec", "location": "/WINDOWS/comsetup.log", "parent": {"type_indicator": "EWF", "__type__": "PathSpec", "parent": {"type_indicator": "OS", "__type__": "PathSpec", "location": "/media/sf_J_DRIVE/xp-tdungan-c-drive.E01"}}}'))

    print('')
    print('[basic] Print comsetup.log infto from xp')
    print(str(dfvfs_util_xp.get_pathspec_basic_information(dfvfs_util_xp.decode_pathspec('{"inode": 3796, "type_indicator": "TSK", "__type__": "PathSpec", "location": "/WINDOWS/comsetup.log", "parent": {"type_indicator": "EWF", "__type__": "PathSpec", "parent": {"type_indicator": "OS", "__type__": "PathSpec", "location": "/media/sf_J_DRIVE/xp-tdungan-c-drive.E01"}}}'))))

    print('')
    print('[full info] Print comsetup.log infto from xp')
    print(str(dfvfs_util_xp.get_pathspec_information(dfvfs_util_xp.decode_pathspec('{"inode": 3796, "type_indicator": "TSK", "__type__": "PathSpec", "location": "/WINDOWS/comsetup.log", "parent": {"type_indicator": "EWF", "__type__": "PathSpec", "parent": {"type_indicator": "OS", "__type__": "PathSpec", "location": "/media/sf_J_DRIVE/xp-tdungan-c-drive.E01"}}}'))))
